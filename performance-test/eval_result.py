...
MIN_RESPONSE_TIME = os.environ['min_response_time']
MAX_RESPONSE_TIME = os.environ['max_response_time']
AVG_RESPONSE_TIME = os.environ['avg_response_time']

print("\n---- Test Parameters -----\n")
print("MIN_RESPONSE_TIME: %s") % MIN_RESPONSE_TIME
print("MAX_RESPONSE_TIME: %s") % MAX_RESPONSE_TIME
print("AVG_RESPONSE_TIME: %s") % AVG_RESPONSE_TIME
print("\n\n---- Test Result ----\n")
